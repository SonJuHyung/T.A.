		   ...
		   void (*setup)(struct super_block *))
{
	...
	sbi->sector_size = logical_sector_size;
	...
	printk("fs-lecture - fat_start : %x \n", sbi->fat_start*0x200);
	printk("fs-lecture - fat2_start : %lx \n", (sbi->fat_start+sbi->fat_length)*0x200);
	printk("fs-lecture - log_start : %lx \n", sbi->log_start*0x200);
	printk("fs-lecutre - fat_dir_start : %lx \n", sbi->dir_start*0x200);
	printk("fs-lecture - data_start : %lx \n", sbi->data_start*0x200);
